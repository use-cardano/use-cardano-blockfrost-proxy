/*
    100% copied from https://github.com/stegano/next-http-proxy-middleware/blob/master/src/index.ts to avoid having to install the package
    since I was having problems with typescript acting up
*/
